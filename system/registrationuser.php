...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="./system/images/WhatsApp Image 2024-05-12 at 21.51.51_09ba8a5f.jpg" type="image/x-icon">
...
<body>
  <div class="grided">  
  <div class="grid-1">
    <img src="../images/pexels-bradleyhook-142882.jpg" alt="">
  </div>
  <div class="grid-2">
    <div class="text-2">
      <div class="mr-crabs">
...
<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $sql=mysqli_query($con,"INSERT INTO `users` VALUES('','$name','$email','$phonenumber','$address','$password')");
